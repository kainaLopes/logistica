...
class CreateAdministradoresSupervisionaEntregasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('administradores_supervisiona_entregas', function (Blueprint $table) {
            $table->increments('id');
            $table->rememberToken();
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('administradores_supervisiona_entregas');
    }
}
